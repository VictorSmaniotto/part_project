<div class="flex w-full max-w-4xl p-8 mx-auto bg-white rounded-lg shadow-md">

    <form wire:submit.prevent='salvarTrabalho' class="w-full">
        ...
        <div class="mb-4">
            ...
            <input wire:model='title' type="text" name="title" id="title"
                ...
                required placeholder="Escreva o título do projeto...">
            @error('title')
        ...
        <div class="mb-4">
            ...
            <textarea wire:model="description" id="description" name="description"
                ...
                placeholder="Escreva uma introdução sobre seu projeto..."></textarea>
            @error('description')
            <span class="text-red-500">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="file" wire:model="file" id="file" name="file"
                class="block w-full p-2 mt-1 text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-600 hover:file:bg-blue-100">
                @error('file')
                <span class="text-red-500">{{ $message }}</span>
                @enderror
        </div>
